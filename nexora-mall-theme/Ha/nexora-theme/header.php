...
<head>
    ...
    <meta name="description" content="NEXORA MALL — Shop Everything. Live Better. The ultimate luxury online marketplace.">
...
<aside class="announcement-bar" aria-label="<?php esc_attr_e( 'Store Announcement', 'nexora-mall' ); ?>">
    <div class="container announcement-inner">
        <div>
            <span class="badge badge-gold" style="margin-right: 0.5rem;"><?php esc_html_e( 'Luxury Premiere', 'nexora-mall' ); ?></span>
...
<header class="site-header" id="main-header">
    <div class="container header-main">
        ...
        <button class="action-btn mobile-menu-toggle" aria-label="<?php esc_attr_e( 'Open Navigation Menu', 'nexora-mall' ); ?>">
        ...
        <div class="header-search-wrap">
            <form role="search" method="get" class="header-search-box" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                <input type="search" class="header-search-input" placeholder="<?php esc_attr_e( 'Search fashion, electronics, luxury home & beauty...', 'nexora-mall' ); ?>" value="<?php echo get_search_query(); ?>" name="s">
        ...
        <!-- Utilities (Dark Mode, Wishlist, Account, Cart) -->
        <div class="header-actions">
            <!-- Theme Toggle Button -->
            <button class="action-btn theme-toggle-btn" aria-label="<?php esc_attr_e( 'Toggle Dark/Light Mode', 'nexora-mall' ); ?>" title="<?php esc_attr_e( 'Toggle Mode', 'nexora-mall' ); ?>">
                ...
                <ul class="nav-links-list">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo esc_url( home_url( '/shop' ) ); ?>" class="nav-link">
                            <?php esc_html_e( 'Shop All', 'nexora-mall' ); ?> <i class="fas fa-chevron-down" style="font-size: 0.65rem;"></i>
                        </a>
...
<div class="mobile-nav-drawer">
    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-color); padding-bottom: 1rem;">
        ...
        <button class="mobile-drawer-close action-btn" aria-label="<?php esc_attr_e( 'Close Menu', 'nexora-mall' ); ?>"><i class="fas fa-xmark"></i></button>
    </div>
